...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_xorgproto_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c4d99508-4286-5418-9131-c86396af500b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_xorgproto", artifacts_toml) for e in artifacts["Xorg_xorgproto"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_xorgproto; unsupported platform $(triplet(platform_key_abi()))")
else
